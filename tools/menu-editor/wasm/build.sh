...
EXPORTS="_em_init,_em_reset_dynamic,_em_set_style,_em_page_begin,_em_page_item,_em_item_text,_em_item_swtext,_em_item_bits,_em_page_end,_em_pages_commit,_em_frame,_em_key,_em_msgbox,_em_msgbox_close,_em_font_h,_em_font_w,_em_font_utf8_w,_em_get_current_page,_em_get_btn_count,_em_get_btn_last,_em_get_ipool,_em_get_fpool,_em_get_upool,_em_get_dpool,_em_scratch,_em_font_count_export,_em_font_name,_em_dbg_current_item,_em_dbg_set_value,_em_dbg_value_type,_em_dbg_draw_item,_em_dbg_page_len"
